...
- (void)setTabViewController {
    ...
    nav_dynamic.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"动态" image:[UIImage imageNamed:@"信息采集-录像"] tag:0];
    ...
    nav_league.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"联赛" image:[UIImage imageNamed:@"信息采集-已拍录像"] tag:1];
    ...
    nav_personInfo.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"我的" image:[UIImage imageNamed:@"信息采集-已拍照片"] tag:2];
